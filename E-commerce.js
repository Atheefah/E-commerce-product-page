const imageBox = document.querySelector(".image-tab-box");
...
imageBox.addEventListener("click", function (e) {
  ...
  document
    .querySelector(`.image-content-${clicked.dataset.tab}`)
...
const ovarlayCart = document.querySelector(".content-cart");
...
const dotContainer = document.querySelector(".content-image-tab-box");
...
document.addEventListener("keydown", function (e) {
  if (e.key === "ArrowRight") nextSlide();
    ...
    ovarlaySlider.classList.remove("content-active");
  }
});
...
const ovarlaySlider = document.querySelector(".main-content");

productImage.forEach((el, i) => {
  el.addEventListener("click", function (e) {
    ovarlaySlider.classList.add("content-active");
    goToSlide(i);
    curSlide = i;
    activeImg(i);
  });
